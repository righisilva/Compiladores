...
valor:       INTEIRO  {$$ = create_node(@1.first_line, tipo_node, yylval.cadeia, NULL); tipo = 1;}
           | QUEBRADO  {$$ = create_node(@1.first_line, tipo_node, yylval.cadeia, NULL); tipo = 2;}
           | LETRA  {$$ = create_node(@1.first_line, tipo_node, yylval.cadeia, NULL); tipo = 3;}
           | FRASE  {$$ = create_node(@1.first_line, tipo_node, yylval.cadeia, NULL); tipo = 4;}
           ;
